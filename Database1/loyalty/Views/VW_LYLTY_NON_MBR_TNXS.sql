CREATE VIEW [loyalty].[VW_LYLTY_NON_MBR_TNXS]
AS select	distinct '3' as partner_id, a.WorkstationID as pos_no, a.BusinessUnitID as site_no,
		a.POSTXSequenceNumber as trans_no, 
		a.POSTXEndDateTime as sale_date, a.POSItemID as item_nbr,
	...
	from 
		dbo.EG_POS_ITEMLINE a (nolock) JOIN dbo.EG_POS_HEADER b (nolock)
            ...
            and cast(a.POSTXEndDateTime as date) = CONVERT (date, GETDATE()-1);