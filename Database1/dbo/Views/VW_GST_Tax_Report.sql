CREATE VIEW [dbo].[VW_GST_Tax_Report]
AS select * from (
...
C.MFG_GlobalLocationNumber, C.ManufacturerName,C.Sales_GL as Envoy_Sales_GL, substring(Sales_GL,1,8) as SAP_Sales_GL, C.Cost_GL as Envoy_Cost_GL, substring(Cost_GL,1,8) as SAP_Cost_GL
