CREATE VIEW [dbo].[VW_PRICE_SALE_TAX_REDEMPTION]
AS SELECT distinct A.TransactionStatus,A.BusinessUnitID, A.WorkstationID, A.POSTXID,A.BusinessDayDate, A.LineTXType, A.POSItemID as item, A.ItemDescription,  A.RegularSalesUnitPrice, 
...
case when A.transactionstatus = 'Returned' OR A.ItemVoidFlag = 'true'
  ...
  amt_incl_GST_before_discount , A.ExtendedDiscountAmount*(-1) as discount, 
