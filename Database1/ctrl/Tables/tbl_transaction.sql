CREATE TABLE [ctrl].[tbl_transaction] (
    ...
    [tbl_comment]               VARCHAR (255) DEFAULT ('fact table') NULL,
    [tbl_is_active]             BIT           DEFAULT ((1)) NOT NULL,
    [tbl_ref_key_id]            INT           DEFAULT ((0)) NULL,
    [tbl_timestamp_column_name] VARCHAR (255) NULL,
    CONSTRAINT [PK_tbl_transaction_tbl_key] PRIMARY KEY NONCLUSTERED ([tbl_key] ASC) NOT ENFORCED
)
